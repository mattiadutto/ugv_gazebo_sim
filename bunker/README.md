### Usage for the Bunker
No repository is available for Bunker Pro. No tracket dynamics are available for the bunker family. 
...
```bash
    ros2 launch bunker_gazebo_sim bunker_empty_world.launch.py
```
### Parameters of <i>bunker_empty_world.launch.py</i>:
- <b>use_rviz</b>: if you want to launch rviz2 or not, default <i>true</i>.
- <b>rviz_config_file</b>: name of the configuration file for RVIz2, defautl <i>bunker.rviz</i>.
